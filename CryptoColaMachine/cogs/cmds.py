...
class cmds(commands.Cog):
    ...
    async def claim(self, ctx, coin):
        ...
        if coin.lower() not in ['eth', 'ltc', 'bch', 'wax', 'doge', 'vtc', 'deeznuts', 'ban', 'flux', 'xmr', 'nano', 'rvn', 'trx', 'xlm', 'xrp', 'xpr', 'lotto', 'pussy', 'etc', '1mt', 'skill', 'comp', 'dai', 'r0ok', 'shx', 'banana']:
